...
from src.commands.create_evento import CreateEvento, Entrenamiento, Ejercicio
...
class TestCreateEntrenamiento(unittest.TestCase):
    ...
    def test_execute_success(self, mock_dynamo):
        ...
        create_entrenamiento = CreateEvento(self.mock_data)
    ...
    def test_execute_invalid_nombre(self, mock_dynamo):
        ...
        create_entrenamiento = CreateEvento(invalid_data)
