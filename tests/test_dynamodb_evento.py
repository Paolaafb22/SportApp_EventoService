...
#from src.models.evento import Entrenamiento

class TestDynamodbEventoService(unittest.TestCase):
    def test_prueba_comentariado(self):
        self.assertEqual(0, 0)
    '''  @patch('src.dynamodb_evento.boto3')
